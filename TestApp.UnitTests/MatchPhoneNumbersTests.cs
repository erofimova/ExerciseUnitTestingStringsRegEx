...
public class MatchPhoneNumbersTests
{
    ...
    {
        // Arrange
        string phoneNumbers = "+359-2 124-5678, +359 22 986 5432, +359-2-5565-555";
    ...
    {
        // Arrange
        string phoneNumbers = "+359-2 124-5678, +359 2 986 5432, +359-22-555-5555";
        string expected = "+359 2 986 5432";
        // Act
        string result = MatchPhoneNumbers.Match(phoneNumbers);
